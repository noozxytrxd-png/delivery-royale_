...
function broadcastWorldState() {
    if (!isHost) return;
    const state = { type: 'WORLD_STATE', players, packageHolderId, pkgPos: { x: packageMesh.position.x, y: packageMesh.position.y, z: packageMesh.position.z }, housePos: houseGroup.position, gameTime: gameTimeSeconds, weaponDrop };
...
function syncWorldState(state) {
    ...
    syncWeaponDrop(state.weaponDrop);
